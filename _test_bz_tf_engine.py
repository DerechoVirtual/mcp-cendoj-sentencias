...
BANCOS = {
    ...
    "asturias": [
        ...
        ("Llanes",    "ordenanza fiscal",    r"tasa|tarifa|tributo|impuesto|cuota"),
    ...
    "barcelona": [
        ("Terrassa",                  "ruido",            r"soroll|ac[úu]stic|vibraci|ruido"),
        ("Sabadell",                  "residuos",         r"residu|neteja|brossa|deixalleria"),
        ("Badalona",                  "ordenanza fiscal", r"taxa|impost|tarifa|preu"),
        ("Mataró",                    "civismo",          r"civisme|convivènc|convivenc|espai p[úu]blic"),
        ("L'Hospitalet de Llobregat", "ordenanza",        r"ordenan|reglament|taxa"),
        ("Cornellà de Llobregat",     "residuos",         r"residu|neteja|brossa"),
        ("Sant Cugat del Vallès",     "ordenanza",        r"ordenan|reglament|taxa"),
        ("Rubí",                      "movilidad",        r"mobilitat|circulaci|vehicle|VMP"),
        ("Manresa",                   "ordenanza fiscal", r"taxa|impost|tarifa|preu"),
        ("Granollers",                "ordenanza",        r"ordenan|reglament|taxa"),
        ("Vilanova i la Geltrú",      "ordenanza",        r"ordenan|reglament|taxa"),
        ("Castelldefels",             "ordenanza",        r"ordenan|reglament|taxa"),
    ],
    "navarra": [
        ("Pamplona",        "terrazas",         r"terraza|hosteler|v[íi]a p[úu]blica"),
        ("Tudela",          "ordenanza",        r"ordenanza|reglamento|tasa"),
        ("Barañáin",        "ordenanza fiscal", r"tasa|tarifa|impuesto|precio"),
        ("Estella-Lizarra", "animales",         r"animal|perro|can"),
        ("Burlada",         "ordenanza",        r"ordenanza|reglamento|tasa"),
        ("Zizur Mayor",     "ordenanza",        r"ordenanza|reglamento|tasa"),
        ("Tafalla",         "ordenanza",        r"ordenanza|reglamento|tasa"),
        ("Villava",         "ordenanza",        r"ordenanza|reglamento|tasa"),
        ("Ansoáin",         "ordenanza",        r"ordenanza|reglamento|tasa"),
        ("Corella",         "ordenanza",        r"ordenanza|reglamento|tasa"),
        ("Cintruénigo",     "ordenanza",        r"ordenanza|reglamento|tasa"),
        ("Sangüesa",        "ordenanza",        r"ordenanza|reglamento|tasa"),
    ],
    "cordoba": [
        ("Lucena",               "veladores terrazas",  r"terraza|velador|ocupaci|v[íi]a p[úu]blica"),
        ("Pozoblanco",           "veladores",           r"terraza|velador|ocupaci"),
        ("Córdoba",              "ambulante",           r"ambulante|mercadillo|venta|puesto"),
        ("Montilla",             "cementerio",          r"cementerio|sepultur|nicho|funerari"),
        ("Priego de Córdoba",    "ambulante",           r"ambulante|mercadillo|venta|puesto"),
        ("Cabra",                "plusvalia",           r"incremento de valor|plusval|terrenos"),
        ("Baena",                "vados",               r"vado|entrada de veh|garaje|cochera"),
        ("Palma del Río",        "animales",            r"animal|perro|can|tenencia"),
        ("Peñarroya-Pueblonuevo", "cementerio",         r"cementerio|sepultur|nicho|funerari"),
        ("Puente Genil",         "ambulante",           r"ambulante|mercadillo|venta|puesto"),
        ("Villanueva de Córdoba", "cementerio",         r"cementerio|sepultur|nicho|funerari"),
        ("Fernán Núñez",         "ambulante",           r"ambulante|mercadillo|venta|puesto"),
    ],
    "baleares": [
        ("Calvià",                  "residuos",   r"residu|recollida|neteja"),
        ("Manacor",                 "residuos",   r"residu|recollida|taxa"),
        ("Palma",                   "ordenanza",  r"ordenan|reglament|taxa"),
        ("Marratxí",                "ordenanza",  r"ordenan|reglament|taxa"),
        ("Llucmajor",               "ordenanza",  r"ordenan|reglament|taxa"),
        ("Santa Eulària des Riu",   "ordenanza",  r"ordenan|reglament|taxa"),
        ("Inca",                    "ordenanza",  r"ordenan|reglament|taxa"),
        ("Sant Antoni de Portmany", "ordenanza",  r"ordenan|reglament|taxa"),
        ("Ciutadella",              "ordenanza",  r"ordenan|reglament|taxa"),
        ("Maó",                     "ordenanza",  r"ordenan|reglament|taxa"),
        ("Felanitx",                "ordenanza",  r"ordenan|reglament|taxa"),
        ("Eivissa",                 "ordenanza",  r"ordenan|reglament|taxa"),
    ],
    "almeria": [
        ("Almería",         "residuos",       r"residuo|limpieza|basura|recogida"),
        ("Roquetas de Mar", "terrazas",       r"terraza|hosteler|quiosco|ocupaci"),
        ("El Ejido",        "taxi",           r"taxi|transporte|viajero|licencia"),
        ("Vícar",           "movilidad VMP",  r"movilidad|VMP|patinete|circulaci"),
        ("Adra",            "animales",       r"animal|perro|tenencia|protecci"),
        ("Níjar",           "ordenanza",      r"ordenanza|reglamento|tasa"),
        ("Huércal-Overa",   "ordenanza",      r"ordenanza|reglamento|tasa"),
        ("Berja",           "ordenanza",      r"ordenanza|reglamento|tasa"),
        ("Vera",            "ordenanza",      r"ordenanza|reglamento|tasa"),
        ("Cuevas del Almanzora", "ordenanza", r"ordenanza|reglamento|tasa"),
        ("Albox",           "ordenanza",      r"ordenanza|reglamento|tasa"),
        ("Garrucha",        "ordenanza",      r"ordenanza|reglamento|tasa"),
    ],
    "girona": [
        ("Girona",             "residuos",   r"residu|escombrar|neteja|brossa"),
        ("Figueres",           "ordenanza",  r"ordenan|reglament|taxa"),
        ("Blanes",             "animales",   r"animal|gos|tinen|protecci"),
        ("Lloret de Mar",      "ordenanza",  r"ordenan|reglament|taxa"),
        ("Olot",               "ordenanza",  r"ordenan|reglament|taxa"),
        ("Salt",               "ordenanza",  r"ordenan|reglament|taxa"),
        ("Palafrugell",        "ordenanza",  r"ordenan|reglament|taxa"),
        ("Sant Feliu de Guíxols", "ordenanza", r"ordenan|reglament|taxa"),
        ("Roses",              "ordenanza",  r"ordenan|reglament|taxa"),
        ("Banyoles",           "ordenanza",  r"ordenan|reglament|taxa"),
        ("Ripoll",             "ordenanza",  r"ordenan|reglament|taxa"),
        ("Puigcerdà",          "ordenanza",  r"ordenan|reglament|taxa"),
    ],
    "tenerife": [
