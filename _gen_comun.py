...
TESAURO = [
    ...
    (r"alcohol|botellon", ["botellon", "consumo de alcohol en la via publica",
                           "beber en la calle"]),
    (r"convivencia|civismo|conductas? en (el )?espacio publico",
     ["convivencia", "civismo", "botellon", "vandalismo", "conductas incivicas"]),
    (r"publicidad|publicitari", ["publicidad", "publicidad exterior", "carteles",
                                 "rotulos", "vallas publicitarias", "lonas"]),
