...
_INSTRUCTIONS = (
    ...
    "doctrina DGT y TEAC/TEAR + CONVENIOS COLECTIVOS (registro REGCON: estatales, autonómicos, provinciales y de empresa) + Registro Mercantil + ordenanzas municipales de los 9 MAYORES "
