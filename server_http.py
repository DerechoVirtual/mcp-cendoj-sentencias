...
_INSTRUCTIONS = (
    ...
    "los ayuntamientos de las PROVINCIAS DE MADRID (toda la Comunidad), BARCELONA (toda la provincia), VALENCIA, NAVARRA, CÓRDOBA, ALMERÍA, GIRONA, ILLES BALEARS, ASTURIAS, BIZKAIA, GIPUZKOA, A CORUÑA, PONTEVEDRA, TARRAGONA, LAS PALMAS, SANTA CRUZ DE TENERIFE, SEVILLA, GRANADA, HUESCA, LEÓN, "
...
def buscar_ordenanzas(municipio: str, consulta: str = "", limite: int = 15) -> str:
    ...
    ayuntamiento de las PROVINCIAS DE MADRID, BARCELONA, VALENCIA, NAVARRA, CÓRDOBA, ALMERÍA, GIRONA, ILLES BALEARS, ASTURIAS, BIZKAIA, GIPUZKOA, A CORUÑA, PONTEVEDRA, TARRAGONA, LAS PALMAS, SANTA CRUZ DE TENERIFE, SEVILLA, GRANADA, HUESCA, LEON, CACERES, TOLEDO, HUELVA, MURCIA, ALICANTE, JAÉN, MÁLAGA-prov y CÁDIZ (Mostoles, Getafe, Vigo, Santiago, Ferrol, Cartagena, Elche, Marbella, Jerez...) via su BOP
